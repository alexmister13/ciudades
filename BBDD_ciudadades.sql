...
--
-- Base de datos: `id3642059_pruebafinal`
--
CREATE DATABASE IF NOT EXISTS `ciudades_hosting` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ciudades_hosting`;
